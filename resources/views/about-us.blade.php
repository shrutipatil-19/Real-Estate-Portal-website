...
<section class="container mx-auto lg:px-16 px-4 mt-7">
    <div class="flex gap-3 items-center">
        ...
        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-sm text-customGray">About Us</span>
    </div>

     <!-- Overview Section -->
     <div class="md:mb-12 grid md:grid-cols-2 py-14 md:py-28">
        <div class="lg:px-[114px] mt-6 md:mt-[48px]">
            <h2 class="text-3xl md:text-5xl font-bold text-customGray mb-6 md:mb-11">Overview</h2>
     ...
     <section class="md:mb-28  grid md:grid-cols-2 md:gap-8 relative">
        ...
        <div class="flex flex-col justify-center">
            <h2 class="text-3xl font-bold mb-6 text-customGray">Our Mission</h2>
    ...
    <div class="grid md:grid-cols-2 items-center lg:px-[114px] gap-8 md:py-28 py-14">
        <div class="md:order-first order-last md:pr-8">
            <h2 class="text-3xl font-bold mb-6 md:mb-8 text-customGray">Our Vision</h2>
...
<section id="Achievements" class="container mx-auto lg:px-16 px-4">
    <div class="flex flex-col items-center justify-center mb-3">
        <span class="lg:text-5xl text-2xl font-bold leading-tight tracking-tight text-center text-customGray mb-3">
            Meet Our Team
        </span>
