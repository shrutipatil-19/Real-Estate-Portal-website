...
<nav class="bg-white">
    ...
    <div id="menu" class="fixed z-10 left-0 top-0 w-64 h-full bg-white shadow-lg transform -translate-x-full transition-transform duration-300 ease-in-out lg:hidden">
        ...
        <ul class="mt-8 space-y-4 p-4">
            <li><a href="{{ route('about-us.index') }}" class="text-customGray hover:text-customGray-600">Home</a></li>
            <li><a href="#" class="text-customGray hover:text-customGray">About Us</a></li>
            <li>
                <a href="{{ route('projects.index') }}" class="text-customGray hover:text-customGray w-full text-left focus:outline-none">Projects</a>
                <ul class="ml-4 mt-2 space-y-2">
                    <li><a href="#" class="text-customGray hover:text-customGray-400">Ongoing</a></li>
                    <li><a href="#" class="text-customGray hover:text-customGray-400">Completed</a></li>
                    <li><a href="#" class="text-customGray hover:text-customGray-400">Upcoming</a></li>
                </ul>
            </li>
     ...
     <div class="container mx-auto flex-col lg:flex lg:flex-row lg:justify-center lg:space-x-8 hidden lg:flex py-3 gap-28 text-customGray text-sm">
         ...
         <div class="relative">
             <a href="{{ route('projects.index') }}" class="text-customGray hover:text-customGray-900 inline-flex items-center">
                 Projects
                 <svg class="w-4 h-4 ml-1 text-customGray" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
