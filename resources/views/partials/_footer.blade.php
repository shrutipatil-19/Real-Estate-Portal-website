        ...
        <div class="grid lg:grid-cols-5 lg:gap-8 gap-5">
            ...
            <div class="hidden lg:block">
                ...
                <ul class="space-y-3 text-base">
                    ...
                    <li><a href="" class="hover:underline">Gallary</a></li>
            ...
            <!-- Subscribe Section -->
            <div>
                <h3 class="text-base font-sans mb-6 hidden lg:block">Contact Us</h3>
                <!--<p class="text-base mb-4 hidden lg:block">Lorem ipsum dolor sit amet consectetur.</p>-->
                  <a href="mailto:info@adcoredevelopers.com">info@adcoredevelopers.com</a>
                   <a href="tel: +912266332229" class="hidden lg:block text-xl ">(+91) 22 66332229
</a>
                <!--<form>-->
